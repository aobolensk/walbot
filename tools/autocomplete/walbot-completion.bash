...
_shtab_walbot_py_subparsers=('autocomplete' 'autoupdate' 'docs' 'help' 'mexplorer' 'patch' 'removehooks' 'restart' 'setuphooks' 'start' 'startmini' 'stop' 'stopmini' 'suspend' 'test')
...
_shtab_walbot_py_docs_option_strings=('-h' '--help' '--name')
...
_shtab_walbot_py_removehooks_option_strings=('-h' '--help' '--name')
_shtab_walbot_py_restart_option_strings=('-h' '--help' '--name' '--autoupdate' '--ignore-version-check' '--fast_start' '--nohup')
_shtab_walbot_py_setuphooks_option_strings=('-h' '--help' '--name')
_shtab_walbot_py_start_option_strings=('-h' '--help' '--name' '--autoupdate' '--ignore-version-check' '--fast_start' '--nohup')
_shtab_walbot_py_startmini_option_strings=('-h' '--help' '--name' '--fast_start' '--nohup' '-m' '--message')
_shtab_walbot_py_stop_option_strings=('-h' '--help' '--name')
_shtab_walbot_py_stopmini_option_strings=('-h' '--help' '--name' '--fast_start' '--nohup')
_shtab_walbot_py_suspend_option_strings=('-h' '--help' '--name' '--fast_start' '--nohup' '-m' '--message')
_shtab_walbot_py_test_option_strings=('-h' '--help' '--name' '-v' '--verbose' '-vv' '--verbose2')



_shtab_walbot_py_pos_0_choices=('autocomplete' 'autoupdate' 'docs' 'help' 'mexplorer' 'patch' 'removehooks' 'restart' 'setuphooks' 'start' 'startmini' 'stop' 'stopmini' 'suspend' 'test')
...
_shtab_walbot_py_removehooks__h_nargs=0
_shtab_walbot_py_removehooks___help_nargs=0
_shtab_walbot_py_restart__h_nargs=0
_shtab_walbot_py_restart___help_nargs=0
_shtab_walbot_py_restart___autoupdate_nargs=0
_shtab_walbot_py_restart___ignore_version_check_nargs=0
_shtab_walbot_py_restart___fast_start_nargs=0
_shtab_walbot_py_restart___nohup_nargs=0
_shtab_walbot_py_setuphooks__h_nargs=0
_shtab_walbot_py_setuphooks___help_nargs=0
_shtab_walbot_py_start__h_nargs=0
_shtab_walbot_py_start___help_nargs=0
_shtab_walbot_py_start___autoupdate_nargs=0
_shtab_walbot_py_start___ignore_version_check_nargs=0
